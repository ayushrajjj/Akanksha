...
export function WhatsAppButton({ whatsappNumber }: WhatsAppButtonProps) {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className="fixed bottom-4 right-4 z-40 hidden items-center gap-2 rounded-full bg-forest-900 px-5 py-3 text-sm font-semibold text-white shadow-soft transition hover:-translate-y-0.5 hover:bg-forest-800 focus-ring md:inline-flex"
